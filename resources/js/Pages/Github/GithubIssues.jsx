                    ...
                    <div className="issues-heading">
                        ...
                        <div className="open-closed-buttons">
                            ...
                            <button>
                                ...
                                <span className="font-bold">254 Closed</span>
                            </button>
                        </div>
                    </div>
                    <div className="issues-table">
                        {fakeArray.map(item => (
                            <div className="issues-entry">
                                <div key={item} className="issues-entry-title-container">
                                    <svg
                                        className="open"
                                        viewBox="0 0 16 16"
                                        version="1.1"
                ...
                <div className="comments-container">
                    ...
                    {fakeArray.map(item => (
                        <div key="item" className="comment-container">
                            ...
                            <div className="comment">
                                <div className="comment-heading">
                                    <a href="#">mdajo6</a> commented 4 days ago
                                </div>
                                <div className="comment-body">
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum
                                    sint optio et sit nemo expedita excepturi corrupti delectus? Unde
